...
// Now, mark all function definitions outside the class as inline.

inline bool bigint::is_bigint(std::string s)
{
    if (s[0] == '-')
        s.erase(0, 1);
...
inline bool bigint::is_minimum(std::string str1, std::string str2)
{
...
inline bool bigint::is_strictlyMaximum(std::string str1, std::string str2)
{
    if (str1 == str2)
        return false;
    if (str1 == maximum(str1, str2))
...
inline bool bigint::is_strictlyMinimum(std::string str1, std::string str2)
{
    if (str1 == str2)
        return false;
    if (str2 == maximum(str1, str2))
...
inline std::string bigint::reverse(std::string s)
{
    bool fl = false;
    if (s[0] == '-')
    {
...
inline std::string bigint::lcm(std::string str1, std::string str2)
{
    return divide(multiply(str1, str2), gcd(str1, str2));
}

inline std::string bigint::fact(std::string s)
{
    if (s[0] == '-')
...
inline bool bigint::isPalindrome(std::string s)
{
    if (s[0] == '-')
        s.erase(0, 1);
    unsigned long long int beg = 0, end = s.length() - 1;
...
inline bool bigint::isPrime(std::string s)
{
    if (maximum(s, "2") != s)
        return false;
    std::string sq = bigint::sqrt(s);
    std::string i = "";
    for (i = "2"; is_maximum(sq, i); i = add(i, "1"))
    {
        if (mod(s, i) == "0")
            return false;
    }
